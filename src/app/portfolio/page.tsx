...
export default function PortfolioLanding() {
    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center bg-black">
        <div className="text-center">
          ...
          <h2 className="text-white text-xl font-medium mb-4">Loading Portfolio</h2>
          ...
          <p className="text-white/60 text-sm mt-3">
            {Math.round((imagesLoaded / totalImages) * 100)}% loaded
          </p>
        </div>
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row overflow-hidden bg-black animate-fade-in">
      {/*Portfolio*/}
      <div
